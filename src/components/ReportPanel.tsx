    ...
    <div className="report-panel w-full bg-black/90 p-4">
      {!showCategories ? (
        <button
          ...
          disabled={disabled}
          className="w-full rounded-lg border-2 border-red-500 bg-red-900/30 py-4 font-mono text-lg font-bold uppercase text-red-500 transition-all hover:bg-red-900/50 active:scale-95 disabled:opacity-50"
        >
          [ REPORT ANOMALY ]
        </button>
      ) : (
